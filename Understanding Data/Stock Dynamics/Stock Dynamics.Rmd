...
**Note**: Instead of checking whether the minimum date is the same in all datasets, we can temporarily merge them using the rbind function:
```{r}
str(rbind(Boeing,GE,ProcterGamble,CocaCola,IBM))
```
...
**Answer**: Using the above results we see it is 2009.
...
**Answer**: We see from the graph that it peaked around 1973.

Around what year did Coca-Cola has its lowest stock price in this time period?

**Answer**: It hit its lowest around 1980.
...
**Answer**: The Procter and Gamble dropped more.
...
**Answer**: Let's draw another vertical line to help visualize:
```{r}
plot(CocaCola$Date, CocaCola$StockPrice, type="l", col="red")
lines(ProcterGamble$Date, ProcterGamble$StockPrice, lty=2, col="blue")
abline(v=as.Date(c("1983-01-01")),lwd=1)
abline(v=as.Date(c("1983-12-01")),lwd=1)
```

We see that Procter and Gamble's was going down and Coca-Cola's up, although in general, Coca-Cola's had a lower value in this period.
...
**Answer**: GE (orange curve) fell the most.

###Problem 3.2 - Visualizing Stock Dynamics 1995-2005

Which stock reaches the highest value in the time period 1995-2005?

**Answer**: IBM (blue) reaches the highest value.
...
**Answer**: Let's narrow down the x axis:
```{r}
plot(CocaCola$Date[301:432], CocaCola$StockPrice[301:432], type="l", col="red", xlim=(c(as.Date("1997-01-01"),as.Date("1998-11-01"))),ylim=c(0,210))
lines(ProcterGamble$Date[301:432], ProcterGamble$StockPrice[301:432], col="green")
lines(IBM$Date[301:432], IBM$StockPrice[301:432], col="blue")
lines(GE$Date[301:432], GE$StockPrice[301:432], col="orange")
lines(Boeing$Date[301:432], Boeing$StockPrice[301:432], col="black")
...
Procter and Gamble (green) and Boeing (black) saw a decrease.
...
**Answer**: Again, narrowing down the x axis:
```{r}
plot(CocaCola$Date[301:432], CocaCola$StockPrice[301:432], type="l", col="red", xlim=(c(as.Date("2004-01-01"),as.Date("2005-12-01"))),ylim=c(0,210))
lines(ProcterGamble$Date[301:432], ProcterGamble$StockPrice[301:432], col="green")
lines(IBM$Date[301:432], IBM$StockPrice[301:432], col="blue")
lines(GE$Date[301:432], GE$StockPrice[301:432], col="orange")
lines(Boeing$Date[301:432], Boeing$StockPrice[301:432], col="black")
...
Boeing (black) is performing the best.
...
**Answer**: January, February, March, April, and May have higher average stock prices than average.
...
```{r}
sort(tapply(GE$StockPrice, months(IBM$Date), mean))
sort(tapply(CocaCola$StockPrice, months(IBM$Date), mean))
```

**Answer**: Both companies have their highest average stock in April.
...
**Answer**: We just saw that for Coca-Cola and GE, December has a lower average.
